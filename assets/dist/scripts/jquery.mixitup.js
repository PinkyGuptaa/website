!function(t, e) {
    ...
    t.MixItUp.prototype = {
        ...
        _init: function(e, i) {
            var a = this;
            if (a._execAction("_init", 0, arguments),
            i && t.extend(!0, a, i),
            a._$body = t("body"),
            a._domNode = e,
            a._$container = t(e),
            ...
            a._refresh(!0),
            a._$parent = a._$targets.parent().length ? a._$targets.parent() : a._$container,
            a.load.sort && (a._newSort = a._parseSort(a.load.sort),
            a._newSortString = a.load.sort,
            a._activeSort = a.load.sort,
            a._sort(),
            a._printSort()),
            a._activeFilter = "all" === a.load.filter ? a.selectors.target : "none" === a.load.filter ? "" : a.load.filter,
            ...
            a.controls.toggleFilterButtons) {
                ...
                a.controls.enable && a._updateControls({
        ...
        _platformDetect: function() {
            ...
            t._ff = !!n && parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]),
            t._prefix = s.prefix,
            t._vendor = s.vendor,
        ...
        _bindHandlers: function() {
            ...
            a[i.selectors.filter] = a[i.selectors.filter] === e ? 1 : a[i.selectors.filter] + 1,
            r[i.selectors.sort] = r[i.selectors.sort] === e ? 1 : r[i.selectors.sort] + 1,
        ...
        _processClick: function(i, a) {
            var r = this
              , n = function(i, a, n) {
                ...
                s._handled["_" + a][r.selectors[a]] = s._handled["_" + a][r.selectors[a]] === e ? 1 : s._handled["_" + a][r.selectors[a]] + 1,
                s._handled["_" + a][r.selectors[a]] === s._bound["_" + a][r.selectors[a]] && (i[(n ? "remove" : "add") + "Class"](r.controls.activeClass),
                delete s._handled["_" + a][r.selectors[a]])
            };
            if (r._execAction("_processClick", 0, arguments),
            !r._mixing || r.animation.queue && r._queue.length < r.animation.queueLimit) {
                if (r._clicking = !0,
                "sort" === a) {
                    var s = i.attr("data-sort");
                    (!i.hasClass(r.controls.activeClass) || s.indexOf("random") > -1) && (t(r.selectors.sort).removeClass(r.controls.activeClass),
                    n(i, a),
                    r.sort(s))
                }
                if ("filter" === a) {
                    var o, l = i.attr("data-filter"), c = "or" === r.controls.toggleLogic ? "," : "";
                    r.controls.toggleFilterButtons ? (r._buildToggleArray(),
                    i.hasClass(r.controls.activeClass) ? (n(i, a, !0),
                    o = r._toggleArray.indexOf(l),
                    r._toggleArray.splice(o, 1)) : (n(i, a),
                    r._toggleArray.push(l)),
                    r._toggleArray = t.grep(r._toggleArray, function(t) {
                        return t
                    }),
                    r._toggleString = r._toggleArray.join(c),
                    r.filter(r._toggleString)) : i.hasClass(r.controls.activeClass) || (t(r.selectors.filter).removeClass(r.controls.activeClass),
                    n(i, a),
                    r.filter(l))
                }
                r._execAction("_processClick", 1, arguments)
            } else
                "function" == typeof r.callbacks.onMixBusy && r.callbacks.onMixBusy.call(r._domNode, r._state, r),
        ...
        _updateControls: function(i, a) {
            ...
            for (var l = 0; l < 2; l++)
                (o = r.controls.live ? t(r.selectors[s]) : r["_$" + s + "Buttons"]) && function(t, e) {
                    try {
        ...
        _printSort: function(t) {
            ...
            for (var n = 0; n < i.length; n++) {
                var s = i[n]
                  , o = s.nextSibling;
                "absolute" !== s.style.position && (o && "#text" === o.nodeName && this._$parent[0].removeChild(o),
        ...
        _parseEffects: function() {
            var t = this
              ...
              , a = function(t, a) {
                for (var r = [["scale", ".01"], ["translateX", "20px"], ["translateY", "20px"], ["translateZ", "20px"], ["rotateX", "90deg"], ["rotateY", "90deg"], ["rotateZ", "180deg"], ], n = 0; n < r.length; n++) {
                    var s, o, l = r[n][0], c = r[n][1], g = a && "scale" !== l;
                    e[t] += i(l) ? l + "(" + (s = i(l, !0).val || c,
                    (o = g) ? "-" === s.charAt(0) ? s.substr(1, s.length) : "-" + s : s) + ") " : ""
                }
            };
        ...
        _buildState: function(t) {
            var e = this
              , i = {};
            if (e._execAction("_buildState", 0),
            i = {
        ...
        _prepTargets: function() {
            ...
            for (var i = 0; i < this._$toShow.length; i++) {
                ...
                r.css(e._in),
                this.animation.animateResizeTargets && (a.style.width = a.dataset.finalWidth + "px",
                a.style.height = a.dataset.finalHeight + "px",
                a.style.marginRight = -(a.dataset.finalWidth - a.dataset.interWidth) + 1 * a.dataset.finalMarginRight + "px",
                a.style.marginBottom = -(a.dataset.finalHeight - a.dataset.interHeight) + 1 * a.dataset.finalMarginBottom + "px")
            }
            for (var i = 0; i < this._$pre.length; i++) {
                ...
                r.css(e),
                this.animation.animateResizeTargets && (a.style.width = a.dataset.origWidth + "px",
                a.style.height = a.dataset.origHeight + "px",
                a.dataset.origWidth - a.dataset.finalWidth && (a.style.marginRight = -(a.dataset.origWidth - a.dataset.interWidth) + 1 * a.dataset.origMarginRight + "px"),
                a.dataset.origHeight - a.dataset.finalHeight && (a.style.marginBottom = -(a.dataset.origHeight - a.dataset.interHeight) + 1 * a.dataset.origMarginBottom + "px"))
            }
        ...
        _animateTargets: function() {
            ...
            for (var i = 0; i < e._$toShow.length; i++) {
                ...
                for (var l = 0; l < 2; l++) {
                    ...
                    e._ff && e._ff <= 20 && (o[c + "transition-property"] = "all",
            ...
            for (var i = 0; i < e._$pre.length; i++) {
                var a = e._$pre[i]
                  ...
                  , s = e._getDelay(i);
                a.dataset.finalPosX === a.dataset.origPosX && a.dataset.finalPosY === a.dataset.origPosY || e._bindTargetDone(r),
                r.css(e._getPrefixedCSS("transition", "all " + e.animation.duration + "ms " + e.animation.easing + " " + s + "ms")),
                r.css(e._getPrefixedCSS("transform", "translate(" + n.x + "px," + n.y + "px)")),
                e.animation.animateResizeTargets && (a.dataset.origWidth - a.dataset.finalWidth && 1 * a.dataset.finalWidth && (a.style.width = a.dataset.finalWidth + "px",
                a.style.marginRight = -(a.dataset.finalWidth - a.dataset.interWidth) + 1 * a.dataset.finalMarginRight + "px"),
                a.dataset.origHeight - a.dataset.finalHeight && 1 * a.dataset.finalHeight && (a.style.height = a.dataset.finalHeight + "px",
                a.style.marginBottom = -(a.dataset.finalHeight - a.dataset.interHeight) + 1 * a.dataset.finalMarginBottom + "px"))
            }
        ...
        _bindTargetDone: function(e) {
            ...
            a.dataset.bound || (a.dataset.bound = !0,
            i._targetsBound++,
            e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function(r) {
                (r.originalEvent.propertyName.indexOf("transform") > -1 || r.originalEvent.propertyName.indexOf("opacity") > -1) && t(r.originalEvent.target).is(i.selectors.target) && (e.off(".mixItUp"),
                a.dataset.bound = "",
                i._targetDone())
            })),
        ...
        multiMix: function() {
            ...
            t._mixing)
                ...
                t._refresh(),
                a && (t._newSort = t._parseSort(a),
                t._newSortString = a,
                t._sorting = !0,
                t._sort()),
                r !== e && (r = "all" === r ? t.selectors.target : r,
                t._activeFilter = r),
                t._filter(),
                n && (t._newDisplay = "string" == typeof n ? n : n.display || t.layout.display,
        ...
        insert: function() {
            var t = this._parseInsertArgs(arguments)
              ...
              , a = (this._refresh(),
            this._$targets.length) ? t.index < this._$targets.length || !this._$targets.length ? this._$targets[t.index] : this._$targets[this._$targets.length - 1].nextElementSibling : this._$parent[0].children[0];
            if (this._execAction("insert", 0, arguments),
            t.$object) {
        ...
        getOption: function(t) {
            return t ? this._execFilter("getOption", function(t, i) {
                for (var a = i.split("."), r = a.pop(), n = a.length, s = 1, o = a[0] || i; (t = t[o]) && s < n; )
                    o = a[s],
                    s++;
                if (t !== e)
                    return t[r] !== e ? t[r] : t
        ...
        destroy: function(e) {
            ...
            a[this.selectors.sort] && a[this.selectors.sort] > 1 ? a[this.selectors.sort]-- : 1 === a[this.selectors.sort] && delete a[this.selectors.sort],
            delete t.MixItUp.prototype._instances[this._id]
        }
    },
    t.fn.mixItUp = function() {
        var i, a = arguments, r = [], n = function(e, i) {
            var a = new t.MixItUp;
            ...
            a._instances[e.id] || (a._instances[e.id] = a,
            a._init(e, i)),
        ...
        this.each(function() {
            for (var r = this, n = i.split(" "), s = 0; s < n.length; s++)
                for (var o = 0; o < 4; o++) {
                    ...
                    if (r.style[l] !== e && "unknown" != typeof r.style[l] && r.style[l].length > 0 && (r.style[l] = ""),
                    !a && 1 === o)
                        break
                }
