!function(e) {
    ...
    var m, f, g, v = a.MutationObserver || a.WebKitMutationObserver || !1, w = Date.now || function() {
    ...
    , b = {
        ...
        scriptpath: (f = l.currentScript || !!(m = l.getElementsByTagName("script")).length && m[m.length - 1],
        g = f ? f.src.split("?")[0] : "",
        g.split("/").length > 0 ? g.split("/").slice(0, -1).join("/") + "/" : ""),
        ...
        e)
            for (var x in g)
                void 0 !== e[x] && (g[x] = e[x]);
        if (g.disablemutationobserver && (v = !1),
        this.doc = g.doc,
        ...
        "auto" == g.rtlmode) {
            ...
            "horizontal-tb" == k || "lr-tb" == k || "" === k ? (this.isrtlmode = "rtl" == z.css("direction"),
            this.isvertical = !1) : (this.isrtlmode = "vertical-rl" == k || "tb" == k || "tb-rl" == k || "rl-tb" == k,
            this.isvertical = "vertical-rl" == k || "tb" == k || "tb-rl" == k)
        } else
        ...
        g.enablemouselockapi || (T.hasmousecapture = !1,
        T.haspointerlock = !1),
        this.debounced = function(e, o, t) {
            m && (m.delaylist[e] || !1 || (m.delaylist[e] = {
                h: u(function() {
                    m.delaylist[e].fn.call(m),
                    m.delaylist[e] = !1
                }, t)
            },
            o.call(m)),
        ...
        this.synched = function(e, o) {
            m.synclist[e] ? m.synclist[e] = o : (m.synclist[e] = o,
            u(function() {
                m && (m.synclist[e] && m.synclist[e].call(m),
                m.synclist[e] = null)
            }))
        }
        ,
        ...
        this.ishwscroll) {
            ...
            T.hastranslate3d && g.enabletranslate3d ? (this.setScrollTop = function(e, o) {
                ...
                m.doc.css(T.trstyle, "translate3d(" + m.doc.translate.tx + "," + m.doc.translate.ty + ",0)"),
            ...
            this.setScrollLeft = function(e, o) {
                ...
                m.doc.translate.y = e,
                m.doc.translate.ty = -1 * e + "px",
                m.doc.css(T.trstyle, "translate(" + m.doc.translate.tx + "," + m.doc.translate.ty + ")"),
                o || m.notifyScrollEvent(m.win[0])
            }
            ,
            this.setScrollLeft = function(e, o) {
            ...
            this.setScrollLeft = function(e) {
                return setTimeout(function() {
                    if (m)
                        return m.hasreversehr && (e = m.detected.ismozilla ? -(m.page.maxw - e) : m.page.maxw - e),
        ...
        this.updateScrollBar = function(e) {
            ...
            if (m.ishwscroll)
                ...
                o.left += m.rail.align ? m.win.outerWidth() - N(m.win, "border-right-width") - m.rail.width : N(m.win, "border-left-width"),
                (t = g.railoffset) && (t.top && (o.top += t.top),
                t.left && (o.left += t.left)),
                m.railslocked || m.rail.css({
                    top: o.top,
                    left: o.left,
                ...
                m.railh && !m.railslocked) {
                    ...
                    (t = g.railhoffset) && (t.top && (o.top += t.top),
                    t.left && (o.left += t.left));
        ...
        this.doRailClick = function(e, o, t) {
            ...
            r(0 | s)) : (r = t ? m.doScrollLeftBy : m.doScrollBy,
            s = t ? m.scroll.x : m.scroll.y,
            n = t ? e.pageX - m.railh.offset().left : e.pageY - m.rail.offset().top,
        ...
        this.init = function() {
            ...
            T.isoperamini)
                return !0;
            if (T.isandroid && !("hidden"in l))
                return !0;
            g.emulatetouch = g.emulatetouch || g.touchbehavior,
            m.hasborderbox = a.getComputedStyle && "border-box" === a.getComputedStyle(l.body)["box-sizing"];
            var e = {
                "overflow-y": "hidden"
            };
            if ((T.isie11 || T.isie10) && (e["-ms-overflow-style"] = "none"),
            m.ishwscroll && (this.doc.css(T.transitionstyle, T.prefixstyle + "transform 0ms ease-out"),
            T.transitionend && m.bind(m.doc, T.transitionend, m.onScrollTransitionEnd, !1)),
            m.zindex = "auto",
            m.ispage || "auto" != g.zindex ? m.zindex = g.zindex : m.zindex = function() {
                var e = m.win;
                if ("zIndex"in e)
                    return e.zIndex();
                for (; e.length > 0; ) {
            ...
            !m.ispage || !T.isieold) {
                ...
                !T.isios || m.ispage || m.haswrapper || m.css(f, {
                ...
                m.rail.drag = !1;
                var y, x = !1;
                if (!g.boxzoom || m.ispage || T.isieold || (x = l.createElement("div"),
                ...
                T.cantouch && g.gesturezoom && (m.ongesturezoom = function(e) {
                    return e.scale > 1.5 && m.doZoomIn(e),
                    e.scale < .8 && m.doZoomOut(e),
                    m.cancelEvent(e)
                }
                ,
                m.bind(m.win, "gestureend", m.ongesturezoom))),
                m.railh = !1,
                g.horizrailenabled && (m.css(i, {
                    overflowX: "hidden"
                }),
                ...
                m.ispage)
                    ...
                    if (m.ishwscroll) {
                        ...
                        m.viewport && (m.body = m.viewport,
                        /fixed|absolute/.test(m.viewport.css("position")) || m.css(m.viewport, {
                            position: "relative"
                        })),
                        u.css({
                            position: k
                    ...
                    g.disableoutline && (T.isie && m.win.attr("hideFocus", "true"),
                    T.iswebkit && m.win.css("outline", "none"))
                }
                if (!1 === g.autohidemode ? (m.autohidedom = !1,
                m.rail.css({
                    opacity: g.cursoropacitymax
                }),
                m.railh && m.railh.css({
                    opacity: g.cursoropacitymax
                })) : !0 === g.autohidemode || "leave" === g.autohidemode ? (m.autohidedom = n().add(m.rail),
                T.isie8 && (m.autohidedom = m.autohidedom.add(m.cursor)),
                m.railh && (m.autohidedom = m.autohidedom.add(m.railh)),
                m.railh && T.isie8 && (m.autohidedom = m.autohidedom.add(m.cursorh))) : "scroll" == g.autohidemode ? (m.autohidedom = n().add(m.rail),
                m.railh && (m.autohidedom = m.autohidedom.add(m.railh))) : "cursor" == g.autohidemode ? (m.autohidedom = n().add(m.cursor),
                m.railh && (m.autohidedom = m.autohidedom.add(m.cursorh))) : "hidden" == g.autohidemode && (m.autohidedom = !1,
                m.hide(),
                m.railslocked = !1),
                T.cantouch || m.istouchcapable || g.emulatetouch || T.hasmstouch) {
                    ...
                    m.ontouchstart = function(e) {
                        ...
                        if (e.pointerType && ("mouse" === e.pointerType || e.pointerType === e.MSPOINTER_TYPE_MOUSE))
                            return !1;
                        if (m.hasmoving = !1,
                        m.scrollmom.timer && (m.triggerScrollEnd(),
                        m.scrollmom.stop()),
                        !m.railslocked) {
                            var o = m.getTarget(e);
                            if (o)
                            ...
                            o && t) {
                                if (!/INPUT|SELECT|BUTTON|TEXTAREA/i.test(o.nodeName))
                                    return T.hasmousecapture && o.setCapture(),
                                    g.emulatetouch ? (o.onclick && !o._onclick && (o._onclick = o.onclick,
                    ...
                    m.ontouchend = function(e) {
                        ...
                        if (2 == m.rail.drag.pt) {
                            ...
                            if (m.hasmoving && (m.scrollmom.doMomentum(),
                            m.lastmouseup = !0,
                            m.hideCursor(),
                            T.hasmousecapture && l.releaseCapture(),
                            o))
                                return m.cancelEvent(e)
                        } else if (1 == m.rail.drag.pt)
                            return m.onmouseup(e)
                    }
                    ;
                    ...
                    m.ontouchmove = function(e, o) {
                        ...
                        if (2 == m.rail.drag.pt) {
                            ...
                            if (m.ishwscroll && g.bouncescroll)
                                d < 0 ? d = Math.round(d / 2) : d > m.page.maxh && (d = m.page.maxh + Math.round((d - m.page.maxh) / 2));
                            else if (d < 0 ? (d = 0,
                            s = 0) : d > m.page.maxh && (d = m.page.maxh,
                            s = 0),
                            0 === s && !m.hasmoving)
                                return m.ispage || (m.rail.drag = !1),
                                !0;
                            var u = m.getScrollLeft();
                            if (m.railh && m.railh.scrollable && (u = m.isrtlmode ? c - m.rail.drag.sl : m.rail.drag.sl - c,
                            m.ishwscroll && g.bouncescroll ? u < 0 ? u = Math.round(u / 2) : u > m.page.maxw && (u = m.page.maxw + Math.round((u - m.page.maxw) / 2)) : (u < 0 && (u = 0,
                            a = 0),
                            u > m.page.maxw && (u = m.page.maxw,
                            a = 0))),
                            !m.hasmoving) {
                                if (m.rail.drag.y === e.clientY && m.rail.drag.x === e.clientX)
                                    return m.cancelEvent(e);
                                var h = Math.abs(n)
                                  , p = Math.abs(c)
                                  , f = g.directionlockdeadzone;
                                if (m.rail.drag.ck ? "v" == m.rail.drag.ck ? p > f && h <= M ? m.rail.drag = !1 : h > f && (m.rail.drag.dl = "v") : "h" == m.rail.drag.ck && (h > f && p <= M ? m.rail.drag = !1 : p > f && (m.rail.drag.dl = "h")) : h > f && p > f ? m.rail.drag.dl = "f" : h > f ? m.rail.drag.dl = p > M ? "f" : "v" : p > f && (m.rail.drag.dl = h > M ? "f" : "h"),
                                !m.rail.drag.dl)
                                    return m.cancelEvent(e);
                                m.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0),
                                m.hasmoving = !0
                            }
                            return m.preventclick && !m.preventclick.click && (m.preventclick.click = m.preventclick.tg.onclick || !1,
                            ...
                            m.synched("touchmove", function() {
                                m.rail.drag && 2 == m.rail.drag.pt && (m.prepareTransition && m.resetTransition(),
                                m.rail.scrollable && m.setScrollTop(d),
                                m.scrollmom.update(a, s),
                                m.railh && m.railh.scrollable ? (m.setScrollLeft(u),
                                m.showCursor(d, u)) : m.showCursor(d),
                    ...
                    m.ontouchstartCursor = function(e, o) {
                        if (!m.rail.drag || 3 == m.rail.drag.pt) {
                            ...
                            var t = m.getTarget(e);
                            return !m.ispage && T.hasmousecapture && t.setCapture(),
                    ...
                    m.ontouchmoveCursor = function(e) {
                        if (m.rail.drag) {
                            if (3 != m.rail.drag.pt)
                                return;
                            if (m.cursorfreezed = !0,
                            m.rail.drag.hr) {
                                m.scroll.x = m.rail.drag.sx + (e.touches[0].clientX - m.rail.drag.x),
                                m.scroll.x < 0 && (m.scroll.x = 0);
                                var o = m.scrollvaluemaxw;
                                m.scroll.x > o && (m.scroll.x = o)
                            } else {
                                m.scroll.y = m.rail.drag.sy + (e.touches[0].clientY - m.rail.drag.y),
                                m.scroll.y < 0 && (m.scroll.y = 0);
                                var t = m.scrollvaluemax;
                                m.scroll.y > t && (m.scroll.y = t)
                            }
                            return m.synched("touchmove", function() {
                                m.rail.drag && 3 == m.rail.drag.pt && (m.showCursor(),
                                m.rail.drag.hr ? m.doScrollLeft(Math.round(m.scroll.x * m.scrollratio.x), g.cursordragspeed) : m.doScrollTop(Math.round(m.scroll.y * m.scrollratio.y), g.cursordragspeed))
                            }),
                            m.cancelEvent(e)
                        }
                    }
                ...
                if (m.onmousedown = function(e, o) {
                    if (!m.rail.drag || 1 == m.rail.drag.pt) {
                        ...
                        var t = m.getTarget(e);
                        return T.hasmousecapture && t.setCapture(),
                        m.isiframe && !T.hasmousecapture && (m.saved.csspointerevents = m.doc.css("pointer-events"),
                        m.css(m.doc, {
                            "pointer-events": "none"
                        })),
                ...
                m.onmouseup = function(e) {
                    if (m.rail.drag)
                        return 1 != m.rail.drag.pt || (T.hasmousecapture && l.releaseCapture(),
                        m.isiframe && !T.hasmousecapture && m.doc.css("pointer-events", m.saved.csspointerevents),
                        m.rail.drag = !1,
                        m.cursorfreezed = !1,
                ...
                m.onmousemove = function(e) {
                    if (m.rail.drag) {
                        ...
                        if (T.ischrome && 0 === e.which)
                            return m.onmouseup(e);
                        if (m.cursorfreezed = !0,
                        m.hasmoving || m.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0),
                        m.hasmoving = !0,
                        m.rail.drag.hr) {
                        ...
                        return m.synched("mousemove", function() {
                            m.cursorfreezed && (m.showCursor(),
                            m.rail.drag.hr ? m.scrollLeft(Math.round(m.scroll.x * m.scrollratio.x)) : m.scrollTop(Math.round(m.scroll.y * m.scrollratio.y)))
                        }),
                        m.cancelEvent(e)
                    }
                    m.checkarea = 0
                ...
                T.cantouch || g.emulatetouch)
                    m.onpreventclick = function(e) {
                        if (m.preventclick)
                            return m.preventclick.tg.onclick = m.preventclick.click,
                            m.preventclick = !1,
                            m.cancelEvent(e)
                    }
                    ,
                    m.onclick = !T.isios && function(e) {
                        return !m.lastmouseup || (m.lastmouseup = !1,
                        m.cancelEvent(e))
                    }
                    ,
                    ...
                    var L = function(e) {
                        if (m.selectiondrag) {
                            ...
                            if (0 !== m.selectiondrag.df) {
                                ...
                                m.doScrollBy(r),
                                m.debounced("doselectionscroll", function() {
                                    L()
                                }, 50)
                            }
                        }
                ...
                m.delegate(l, "pointermove", m.ontouchmove)) : T.hasmstouch ? (m.css(m.ispage ? n("html") : m.win, {
                ...
                g.cursordragontouch && (this.istouchcapable || T.cantouch) && (m.bind(m.cursor, "touchstart", m.ontouchstartCursor),
                m.bind(m.cursor, "touchmove", m.ontouchmoveCursor),
                m.bind(m.cursor, "touchend", m.ontouchendCursor),
                m.cursorh && m.bind(m.cursorh, "touchstart", function(e) {
                ...
                g.emulatetouch || T.isandroid || T.isios ? (m.bind(T.hasmousecapture ? m.win : l, "mouseup", m.ontouchend),
                m.onclick && m.bind(l, "click", m.onclick),
                g.cursordragontouch ? (m.bind(m.cursor, "mousedown", m.onmousedown),
                m.bind(m.cursor, "mouseup", m.onmouseup),
                m.cursorh && m.bind(m.cursorh, "mousedown", function(e) {
                    m.onmousedown(e, !0)
                }),
                ...
                m.bind(m.cursor, "mouseup", m.onmouseup),
                m.railh && (m.bind(m.cursorh, "mousedown", function(e) {
                    m.onmousedown(e, !0)
                }),
                m.bind(m.cursorh, "mouseup", m.onmouseup)),
                !m.ispage && g.enablescrollonselection && (m.bind(m.win[0], "mousedown", m.onselectionstart),
                ...
                g.enablemousewheel && (m.isiframe || m.mousewheel(T.isie && m.ispage ? l : m.win, m.onmousewheel),
                m.mousewheel(m.rail, m.onmousewheel),
                m.railh && m.mousewheel(m.railh, m.onmousewheelhr)),
                m.ispage || T.cantouch || /HTML|^BODY/.test(m.win[0].nodeName) || (m.win.attr("tabindex") || m.win.attr({
                    tabindex: ++r
                }),
                ...
                m.onkeypress = function(e) {
                    if (m.railslocked && 0 === m.page.maxh)
                        return !0;
                    e = e || a.event;
                    var r = m.getTarget(e);
                    ...
                    if (m.hasfocus || m.hasmousefocus && !o || m.ispage && !o && !t) {
                        ...
                        case 37:
                        case 63232:
                            m.railh && (s ? m.doScrollLeft(0) : m.doScrollLeftBy(72),
                            c = !0);
                            break;
                        case 39:
                        case 63234:
                            m.railh && (s ? m.doScrollLeft(m.page.maxw) : m.doScrollLeftBy(-72),
                            c = !0);
                            break;
                        case 33:
                        case 63276:
                            m.doScrollBy(m.view.h),
                            c = !0;
                            break;
                        case 34:
                        case 63277:
                        ...
                        case 35:
                        case 63275:
                            m.railh && s ? m.doScrollPos(m.page.maxw, m.page.maxh) : m.doScrollTo(m.page.maxh),
                            c = !0;
                            break;
                        case 32:
                            g.spacebarenabled && (l ? m.doScrollBy(m.view.h) : m.doScrollBy(-m.view.h),
                            c = !0);
                            break;
                        case 27:
                            m.zoomactive && (m.doZoom(),
                            c = !0)
                        }
                        if (c)
                            return m.cancelEvent(e)
                ...
                g.enableobserver && (m.isie11 || !1 === v || (m.observerbody = new v(function(e) {
                    if (e.forEach(function(e) {
                        if ("attributes" == e.type)
                            return f.hasClass("modal-open") && f.hasClass("modal-dialog") && !n.contains(n(".modal-dialog")[0], m.doc[0]) ? m.hide() : m.show()
                    }),
                ...
                !m.ispage && !m.haswrapper)) {
                    ...
                    m.observerremover.observe(P.parentNode, {
                        ...
                        attributes: !1,
                        subtree: !1
                    })) : (m.bind(P, T.isie && !T.isie9 ? "propertychange" : "DOMAttrModified", m.onAttributeChange),
                    T.isie9 && P.attachEvent("onpropertychange", m.onAttributeChange),
                    m.bind(P, "DOMNodeRemoved", function(e) {
                        e.target === P && m.remove()
                    }))
                }
                !m.ispage && g.boxzoom && m.bind(a, "resize", m.resizeZoom),
                m.istextarea && (m.bind(m.win, "keydown", m.lazyResize),
            ...
            if ("IFRAME" == this.doc[0].nodeName) {
                var R = function() {
                    ...
                    T.isios && m.haswrapper && m.css(n(o.body), {
                    ...
                    T.cantouch ? (m.bind(o, "touchstart", m.ontouchstart),
                    m.bind(o, "touchmove", m.ontouchmove)) : g.emulatetouch && (m.bind(o, "mousedown", m.ontouchstart),
                    ...
                    m.zoom && (g.dblclickzoom && m.bind(o, "dblclick", m.doZoom),
        ...
        this.showCursor = function(e, o) {
            if (m.cursortimeout && (clearTimeout(m.cursortimeout),
            m.cursortimeout = 0),
            m.rail) {
                ...
                m.cursoractive = !0),
                m.rail.drag && 1 == m.rail.drag.pt || (void 0 !== e && !1 !== e && (m.scroll.y = e / m.scrollratio.y | 0),
        ...
        this.onResize = function(e, o) {
            ...
            return 0 === m.page.maxh ? (m.hideRail(),
            m.scrollvaluemax = 0,
            m.scroll.y = 0,
            m.scrollratio.y = 0,
            m.cursorheight = 0,
            m.setScrollTop(0),
            m.rail && (m.rail.scrollable = !1)) : (m.page.maxh -= g.railpadding.top + g.railpadding.bottom,
            m.rail.scrollable = !0),
            0 === m.page.maxw ? (m.hideRailHr(),
            m.scrollvaluemaxw = 0,
            m.scroll.x = 0,
            m.scrollratio.x = 0,
            m.cursorwidth = 0,
            m.setScrollLeft(0),
            m.railh && (m.railh.scrollable = !1)) : (m.page.maxw -= g.railpadding.left + g.railpadding.right,
            m.railh && (m.railh.scrollable = g.horizrailenabled)),
            m.railslocked = m.locked || 0 === m.page.maxh && 0 === m.page.maxw,
            m.railslocked ? (m.ispage || m.updateScrollBar(m.view),
            !1) : (m.hidden || (m.rail.visibility || m.showRail(),
            ...
            m.railh && (m.railh.width = m.page.maxh > 0 ? m.view.w - m.rail.width : m.view.w,
            m.scrollvaluemaxw = m.railh.width - m.cursorwidth - (g.railpadding.left + g.railpadding.right)),
            m.ispage || m.updateScrollBar(m.view),
            m.scrollratio = {
                x: m.page.maxw / m.scrollvaluemaxw,
                y: m.page.maxh / m.scrollvaluemax
            },
            m.getScrollTop() > m.page.maxh ? m.doScrollTop(m.page.maxh) : (m.scroll.y = m.getScrollTop() / m.scrollratio.y | 0,
        ...
        this.delegate = function(e, o, t, r, i) {
            ...
            m.bind(e, o, s.f, r, i),
            d[o] = s),
            m.ispage ? (s.a = [m.id].concat(s.a),
            s.l = [t].concat(s.l)) : (s.a.push(m.id),
            s.l.push(t))
        }
        ,
        this.undelegate = function(e, o, t, r, i) {
            ...
            if (s && s.l)
                for (var n = 0, l = s.l.length; n < l; n++)
                    s.a[n] === m.id && (s.a.splice(n),
                    s.l.splice(n),
                    0 === s.a.length && (m._unbind(e, o, s.l.f),
                    d[o] = null))
        }
        ,
        ...
        this.showRail = function() {
            return 0 === m.page.maxh || !m.ispage && "none" == m.win.css("display") || (m.rail.visibility = !0,
            m.rail.css("display", "block")),
            m
        }
        ,
        this.showRailHr = function() {
            return m.railh && (0 === m.page.maxw || !m.ispage && "none" == m.win.css("display") || (m.railh.visibility = !0,
            m.railh.css("display", "block"))),
            m
        }
        ,
        ...
        this.hideRail = function() {
            return m.rail.visibility = !1,
            m.rail.css("display", "none"),
            m
        }
        ,
        this.hideRailHr = function() {
            return m.railh && (m.railh.visibility = !1,
            m.railh.css("display", "none")),
            m
        }
        ,
        this.show = function() {
        ...
        var O = 0
          ...
          , B = 1;
        function X(e, o, t, r) {
            m.scrollrunning || (m.newscrolly = m.getScrollTop(),
            ...
            e = e * B | 0) {
                if (r)
                    if (e < 0) {
                        if (m.getScrollLeft() >= m.page.maxw)
                            return !0
                    } else if (m.getScrollLeft() <= 0)
                        return !0;
                var s = e > 0 ? 1 : -1;
                Y !== s && (m.scrollmom && m.scrollmom.stop(),
                m.newscrollx = m.getScrollLeft(),
                Y = s),
                m.lastdeltax -= e
            }
            if (o) {
                if (function() {
                    ...
                    if (g.nativeparentscrolling && t && !m.ispage && !m.zoomactive)
                        return !0;
                    var n = m.view.h >> 1;
                    m.newscrolly < -n ? (m.newscrolly = -n,
                    o = -1) : m.newscrolly > m.page.maxh + n ? (m.newscrolly = m.page.maxh + n,
                    o = 1) : o = 0
                }
                var l = o > 0 ? 1 : -1;
                O !== l && (m.scrollmom && m.scrollmom.stop(),
        ...
        function A(e, o, t) {
            ...
            if (!t && D)
                return !0;
            (0 === e.deltaMode ? (r = -e.deltaX * (g.mousescrollstep / 54) | 0,
            i = -e.deltaY * (g.mousescrollstep / 54) | 0) : 1 === e.deltaMode && (r = -e.deltaX * g.mousescrollstep * 50 / 80 | 0,
            i = -e.deltaY * g.mousescrollstep * 50 / 80 | 0),
            o && g.oneaxismousemode && 0 === r && i) && (r = i,
            i = 0,
            t && (r < 0 ? m.getScrollLeft() >= m.page.maxw : m.getScrollLeft() <= 0) && (i = r,
            r = 0));
            if (m.isrtlmode && (r = -r),
            !X(r, i, t, !0))
                return D = !1,
        ...
        if (this.onmousewheel = function(e) {
            if (m.wheelprevented || m.locked)
                return !1;
            if (m.railslocked)
                return m.debounced("checkunlock", m.resize, 250),
                !1;
            if (m.rail.drag)
                return m.cancelEvent(e);
            if ("auto" === g.oneaxismousemode && 0 !== e.deltaX && (g.oneaxismousemode = !1),
            g.oneaxismousemode && 0 === e.deltaX && !m.rail.scrollable)
                return !m.railh || !m.railh.scrollable || m.onmousewheelhr(e);
            var o = w()
              , t = !1;
            if (g.preservenativescrolling && m.checkarea + 600 < o && (m.nativescrollingarea = m.isScrollable(e),
            t = !0),
            m.checkarea = o,
            m.nativescrollingarea)
                return !0;
            var r = A(e, !1, t);
            return r && (m.checkarea = 0),
            r
        }
        ,
        this.onmousewheelhr = function(e) {
            if (!m.wheelprevented) {
                if (m.railslocked || !m.railh.scrollable)
                    return !0;
                if (m.rail.drag)
                    return m.cancelEvent(e);
                var o = w()
                  , t = !1;
                return g.preservenativescrolling && m.checkarea + 600 < o && (m.nativescrollingarea = m.isScrollable(e),
                t = !0),
                m.checkarea = o,
                !!m.nativescrollingarea || (m.railslocked ? m.cancelEvent(e) : A(e, !0, t))
            }
        }
        ,
        this.stop = function() {
            return m.cancelScroll(),
        ...
        g.smoothscroll)
            if (m.ishwscroll && T.hastransition && g.usetransition && g.smoothscroll) {
                ...
                this.resetTransition = function() {
                    q = "",
                    m.doc.css(T.prefixstyle + "transition-duration", "0ms")
                }
                ,
                ...
                this.doScrollPos = function(e, o, t) {
                    var r = m.getScrollTop()
                      , i = m.getScrollLeft();
                    if (((m.newscrolly - r) * (o - r) < 0 || (m.newscrollx - i) * (e - i) < 0) && m.cancelScroll(),
                    g.bouncescroll ? (o < 0 ? o = o / 2 | 0 : o > m.page.maxh && (o = m.page.maxh + (o - m.page.maxh) / 2 | 0),
                    e < 0 ? e = e / 2 | 0 : e > m.page.maxw && (e = m.page.maxw + (e - m.page.maxw) / 2 | 0)) : (o < 0 ? o = 0 : o > m.page.maxh && (o = m.page.maxh),
                    ...
                    m.scrollrunning || (m.scrollrunning = !0,
                    m.triggerScrollStart(n, s, e, o, c),
                    m.cursorupdate.start()),
                    m.scrollendtrapped = !0,
                    T.transitionend || (m.scrollendtrapped && clearTimeout(m.scrollendtrapped),
                    m.scrollendtrapped = setTimeout(m.onScrollTransitionEnd, c)),
                ...
                this.onScrollTransitionEnd = function() {
                    if (m.scrollendtrapped) {
                        var e = m.getScrollTop()
                          , o = m.getScrollLeft();
                        if (e < 0 ? e = 0 : e > m.page.maxh && (e = m.page.maxh),
                ...
                this.doScrollPos = function(e, o, t) {
                    ...
                    var s = !1;
                    if (m.bouncescroll && m.rail.visibility || (o < 0 ? (o = 0,
                    s = !0) : o > m.page.maxh && (o = m.page.maxh,
                    s = !0)),
                    m.bouncescroll && m.railh.visibility || (e < 0 ? (e = 0,
                    s = !0) : e > m.page.maxw && (e = m.page.maxw,
                    s = !0)),
                    ...
                    var c = function() {
                        if (m.scrollrunning) {
                            ...
                            e <= 1 ? m.timer = u(c) : (m.scrollrunning = !1,
                            m.timer = 0,
                            m.triggerScrollEnd())
                        }
                    };
                    m.scrollrunning || (m.triggerScrollStart(i, r, e, o, l),
                    m.scrollrunning = !0,
                    m.timer = u(c))
                }
                ,
                this.cancelScroll = function() {
                    return m.timer && h(m.timer),
                    m.timer = 0,
                    m.bzscroll = !1,
                    m.scrollrunning = !1,
                    m
        ...
        m.onscroll = function(e) {
            m.rail.drag || m.cursorfreezed || m.synched("scroll", function() {
                ...
                m.railh && (m.scroll.x = Math.round(m.getScrollLeft() / m.scrollratio.x)),
                m.noticeCursor()
            })
        }
        ,
        ...
        this.doZoomIn = function(e) {
            if (!m.zoomactive) {
                ...
                T.isios4 && (m.zoomrestore.scrollTop = c.scrollTop(),
                c.scrollTop(0)),
                m.win.css({
                ...
                return ("" === n || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(n)) && m.win.css("backgroundColor", "#fff"),
                m.rail.css({
                    zIndex: s + 101
                }),
                m.zoom.css({
    ...
    e.cssHooks.pageYOffset = {
        ...
        set: function(e, o) {
            ...
            return t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : z.call(e, o),
            this
        }
    },
    ...
    n.cssHooks.pageXOffset = {
        ...
        set: function(e, o) {
            var t = n.data(e, "__nicescroll") || !1;
            return t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : k.call(e, o),
            this
        }
    },
    ...
    n.nicescroll || (n.nicescroll = new T,
    n.nicescroll.options = b)
});
