...
!function(i) {
        ...
        return function(t, o) {
            ...
            n.defaults = {
                ...
                customPaging: function(i, e) {
                    return '<button aria-required="false" tabindex="0">' + (e + 1) + "</button>"
                },
                dots: !1,
    ...
    e.prototype.asNavFor = function(e) {
        ...
        t && null !== t && (t = i(t).not(this.$slider)),
    ...
    e.prototype.checkResponsive = function(e, t) {
        ...
        l.options.responsive && l.options.responsive.length && null !== l.options.responsive) {
            ...
            null !== s ? null !== l.activeBreakpoint ? (s !== l.activeBreakpoint || t) && (l.activeBreakpoint = s,
            "unslick" === l.breakpointSettings[s] ? l.unslick(s) : (l.options = i.extend({}, l.originalSettings, l.breakpointSettings[s]),
    ...
    e.prototype.cleanUpEvents = function() {
        var e = this;
        e.options.dots && null !== e.$dots && (i("li", e.$dots).off("click.slick", e.changeSlide),
    ...
    e.prototype.lazyLoad = function() {
        ...
        t = o.options.slidesToShow / 2 + 1 + 2 + o.currentSlide) : (t = (e = o.options.infinite ? o.options.slidesToShow + o.currentSlide : o.currentSlide) + o.options.slidesToShow,
    ...
    e.prototype.progressiveLazyLoad = function() {
        var e, t = this;
        i("img[data-lazy]", t.$slider).length > 0 && ((e = i("img[data-lazy]", t.$slider).first()).attr("src", null),
        ...
        if ("responsive" === e && "array" === i.type(t))
            for (n in t)
                if ("array" !== i.type(l.options.responsive))
                    l.options.responsive = [t[n]];
                else {
                    for (s = l.options.responsive.length - 1; s >= 0; )
                        l.options.responsive[s].breakpoint === t[n].breakpoint && l.options.responsive.splice(s, 1),
                        s--;
    ...
    e.prototype.setPaused = function(i) {
        var e = this;
        !0 === e.options.autoplay && !0 === e.options.pauseOnHover && (e.paused = i,
        i ? e.autoPlayClear() : e.autoPlay())
    }
    ,
    ...
    e.prototype.slideHandler = function(i, e, t) {
        ...
        (!0 !== a.animating || !0 !== a.options.waitForAnimate) && !(!0 === a.options.fade && a.currentSlide === i || a.slideCount <= a.options.slidesToShow))
            ...
            !1 === a.options.infinite && !1 === a.options.centerMode && (i < 0 || i > a.getDotCount() * a.options.slidesToScroll))
                ...
                if (!0 === a.options.autoplay && clearInterval(a.autoPlayTimer),
    ...
    e.prototype.focusHandler = function() {
        ...
        e.$slider.on("focus.slick blur.slick", "*", function(t) {
            ...
            var o = i(this);
            setTimeout(function() {
                e.isPlay && (o.is(":focus") ? (e.autoPlayClear(),
